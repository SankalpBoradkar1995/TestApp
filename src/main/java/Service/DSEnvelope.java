...
public class DSEnvelope 
{
	public String createEnvelope(String signerEmail, String signerName) throws IOException, ApiException {
        ...
        byte[] privateKeyBytes = Files.readAllBytes(Paths.get("C:\\Users\\Sankalp\\Desktop\\Private Key.txt"));
        OAuthToken oAuthToken = apiClient.requestJWTUserToken(
            "ff9a52e6-73a8-483c-b856-752c82497b1f",
            "cf556335-5096-4cae-8c5a-1eb6c243b416",
            scopes,
            privateKeyBytes,
            3600);
        ...
        EnvelopesApi envelopesApi = new EnvelopesApi(apiClient);
            ...
            document.setDocumentBase64("aGVsbG93b3JsZCEhIQ==");
            document.setName("demo.txt");
